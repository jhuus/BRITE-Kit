...
def plot_spec(spec, path, segment_len=cfg.audio.segment_len, show_dims=True, width=None, height=None, x_incr=64):
    ...
    if show_dims:
        ...
        seconds = spec_width / (cfg.audio.spec_width / segment_len)
