...
class Trainer:
    ...
    def run(self):
        ...
        for k in range(cfg.train.num_folds):
            ...
            model = main_model.MainModel(dm.train_class_names, dm.train_class_codes, dm.test_class_names, weights, cfg.train.model_name, num_train_specs=dm.num_train_specs)
