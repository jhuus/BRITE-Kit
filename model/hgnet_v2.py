...
def get_model(model_name, **kwargs):
    if model_name == '1':
        # custom config with ~70K parameters
        config = {
            "stem_type": 'v2',
            "stem_chs": [16, 16],
            ...
            "stage3": [16, 16, 16, 1, True, False, 3, 1],
            "stage4": [16, 16, 16, 1, True, True, 5, 1],
        }
    elif model_name == '2':
        # custom config with ~130K parameters
        config = {
            "stem_type": 'v2',
            "stem_chs": [16, 16],
            # in_chs, mid_chs, out_chs, blocks, downsample, light_block, kernel_size, layer_num
            "stage1": [16, 16, 32, 1, False, False, 3, 1],
            "stage2": [32, 32, 32, 1, True, False, 3, 1],
            "stage3": [32, 32, 32, 2, True, False, 3, 1],
            "stage4": [32, 32, 32, 1, True, True, 5, 1],
        }
    elif model_name == '3':
        # custom config with ~275K parameters
        config = {
            "stem_type": 'v2',
            "stem_chs": [16, 16],
            # in_chs, mid_chs, out_chs, blocks, downsample, light_block, kernel_size, layer_num
