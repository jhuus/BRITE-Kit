...
def get_model(model_name, **kwargs):
    if model_name == '1':
        ...
        config = dict(
            stem_chs=[16, 16, 16],
            stage_conv_chs=[16, 32, 32, 64],
            stage_out_chs=[16, 32, 32, 64],
            layer_per_block=1,
            block_per_stage=[1, 1, 1, 1],
            residual=True,
            depthwise=False,
        ...
        config = dict(
            stem_chs=[32, 32, 32],
            stage_conv_chs=[32, 32, 64, 64],
            stage_out_chs=[32, 32, 64, 64],
            layer_per_block=1,
            block_per_stage=[1, 1, 1, 1],
            residual=True,
            depthwise=False,
        ...
        #  about 200K parameters
        config = dict(
            stem_chs=[32, 32, 32],
            stage_conv_chs=[32, 64, 64, 128],
            stage_out_chs=[32, 64, 64, 128],
            layer_per_block=1,
            block_per_stage=[1, 1, 1, 1],
            residual=True,
            depthwise=False,
        ...
        #  about 550K parameters
        config = dict(
            stem_chs=[32, 32, 32],
            stage_conv_chs=[32, 64, 128, 256],
            stage_out_chs=[32, 64, 128, 256],
            layer_per_block=1,
            block_per_stage=[1, 1, 1, 1],
            residual=True,
            depthwise=False,
        ...
        #  about 750K parameters
        config = dict(
            stem_chs=[32, 32, 64],
            stage_conv_chs=[64, 128, 128, 256],
            stage_out_chs=[64, 128, 128, 256],
            layer_per_block=1,
            block_per_stage=[1, 1, 1, 1],
            residual=True,
            depthwise=False,
        ...
        config = dict(
            stem_chs=[32, 32, 64],
            stage_conv_chs=[64, 64, 128, 256],
            stage_out_chs=[64, 64, 128, 256],
            layer_per_block=1,
